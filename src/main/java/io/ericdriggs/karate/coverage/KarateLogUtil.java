...
public class KarateLogUtil {
     ...
     * <p>
     * 1. Filters to log lines like: 1 > POST http://host.hulu.com/path1?query=val
    ...
    /**
     * Finds log lines like: 1 > POST http://host.hulu.com/path1?query=val
     * and returns list of String like POST http://host.hulu.com/path1
     *
     * @param karateLog
     * @return
     */
